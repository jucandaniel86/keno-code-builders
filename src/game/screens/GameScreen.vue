...
const { results } = storeToRefs(useGameStore())
const { closeCurrentDraw } = useLottery()
</script>
<template>
      ...
      <div class="keno-main-container">
        <div class="keno-paytable">
          ...
          <div class="keno-playtable-container">
            <Draw v-if="results" :results="results" @onAnimationEnds="closeCurrentDraw" />
            <TransitionGroup v-else name="slide" class="slide-wrapper" tag="div">
